...
class GenericPlatform(object):
    ...
    def validate_cpu_count(cls, cpus):
        ...
        :raises ValueTooLowError: if ``cpus`` is less than the minimum required
          by this platform
        :raises ValueTooHighError: if ``cpus`` exceeds the maximum supported
          by this platform
        """
    ...
    def validate_memory_amount(cls, mebibytes):
        ...
        :raises ValueTooLowError: if``mebibytes`` is less than the minimum
          required by this platform
        :raises ValueTooHighError: if ``mebibytes`` is more than the maximum
    ...
    def validate_nic_count(cls, count):
        ...
        :raises ValueTooLowError: if ``count`` is less than the minimum
          required by this platform
        :raises ValueTooHighError: if ``count`` is more than the maximum
          supported by this platform
        """
