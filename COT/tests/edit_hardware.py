...
class TestCOTEditHardware(COT_UT):
    ...
    def test_set_system_type_single(self):
        ...
        self.instance.set_value("PACKAGE", self.input_ovf)
        self.instance.set_value("virtual_system_type", ['vmx-09']) # TODO
        self.instance.run()
...
""")
    ...
    def test_set_system_type_list(self):
        ...
        self.instance.set_value("PACKAGE", self.input_ovf)
        self.instance.set_value("virtual_system_type",
...
""")
    ...
    def test_set_cpus_one_profile(self):
        ...
        self.instance.set_value("PACKAGE", self.input_ovf)
        self.instance.set_value("cpus", 8)
        self.instance.set_value("profiles", ['2CPU-2GB-1NIC']) # TODO
        self.instance.run()
        self.instance.finished()
        self.check_diff(
"""
...
""")
    ...
    def test_set_nic_type_one_profile(self):
        ...
        self.instance.set_value("PACKAGE", self.input_ovf)
        self.instance.set_value("profiles", ['4CPU-4GB-3NIC']) #TODO
...
"""
         <rasd:Connection>VM Network</rasd:Connection>
-        <rasd:Description>VMXNET3 ethernet adapter on "VM Network"</rasd:Description>
+        <rasd:Description>VIRTIO ethernet adapter on "VM Network"</rasd:Description>
         <rasd:ElementName>GigabitEthernet1</rasd:ElementName>
         <rasd:InstanceID>11</rasd:InstanceID>
-        <rasd:ResourceSubType>VMXNET3</rasd:ResourceSubType>
...
""")
    ...
    def test_set_nic_network_one_profile(self):
        ...
        self.instance.set_value("PACKAGE", self.input_ovf)
        self.instance.set_value("nic_networks", ['UT']) # TODO
        self.instance.set_value("profiles", ['2CPU-2GB-1NIC']) # TODO
        self.instance.run()
        self.instance.finished()
        self.check_diff(
...
""")
    ...
    def test_set_nic_mac_address_single_all_profiles(self):
        ...
        self.instance.set_value("PACKAGE", self.input_ovf)
        self.instance.set_value("mac_addresses_list", ['10:20:30:40:50:60']) # TODO
        self.instance.run()
        self.instance.finished()
        self.check_diff(
"""
...
""")
    ...
    def test_set_nic_mac_addresses_list_all_profiles(self):
        ...
        self.instance.set_value("PACKAGE", self.input_ovf)
        self.instance.set_value("mac_addresses_list",
...
""")
    ...
    def test_set_nic_name_pattern(self):
        ...
        self.instance.set_value("PACKAGE", self.input_ovf)
        self.instance.set_value("nic_names", ['eth{0}']) # TODO
        self.instance.run()
        self.instance.finished()
        self.check_diff(
"""
...
""")
    ...
    def test_set_nic_kitchen_sink_no_existing(self):
        ...
        self.instance.set_value("PACKAGE", self.minimal_ovf)
        self.instance.set_value("nics", 1)
        self.instance.set_value("nic_networks", ['testme']) # TODO
        self.instance.set_value("mac_addresses_list", ['12:34:56:78:9a:bc']) # TODO
        self.instance.run()
        self.instance.finished()
        self.check_diff(file1=self.minimal_ovf,
expected="""
...
""")
    ...
    def test_serial_delete_kitchen_sink(self):
        ...
        self.instance.set_value("PACKAGE", self.input_ovf)
        self.instance.set_value("serial_ports", 1)
        self.instance.set_value("serial_connectivity", ['telnet://bar:22']) # TODO
        self.instance.run()
        self.instance.finished()
        self.check_diff(
"""
