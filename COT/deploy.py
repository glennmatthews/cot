...
class COTDeploy(COTReadOnlySubmodule):
    ...
    def validate_arg(self, arg, value):
        ...
        valid, value_or_reason = super(COTDeploy, self).validate_arg(arg, value)
    ...
    def create_subparser(self, parent):
        ...
        self.generic_parser.add_argument('-c', '--configuration', help=
...
"to the new guest.\n"
"If your guest needs environment properties, please either specify a vCenter "
...
"If your guest needs environment properties, please either specify the "
"'--power-on'/'-P' option or provide a vCenter target locator "
